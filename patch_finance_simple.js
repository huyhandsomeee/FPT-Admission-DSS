...
// replace item objects to include id for tracking
code = code.replace(
  '{ name: "Nguyễn Văn A"',
  '{ id: "SCH-01", name: "Nguyễn Văn A"'
);
code = code.replace(
  '{ name: "Trần Thị B"',
  '{ id: "SCH-02", name: "Trần Thị B"'
);
code = code.replace(
  '{ name: "Lê Hoàng C"',
  '{ id: "SCH-03", name: "Lê Hoàng C"'
);
code = code.replace(
